<?php
// source: C:\xampp\htdocs\blog/config/common.neon
// source: C:\xampp\htdocs\blog/config/services.neon
// source: array
...
class Container_f29d373a23 extends Nette\DI\Container
{
	...
	protected array $wiring = [
		...
		'App\Presentation\Edit\EditPresenter' => [2 => ['application.1']],
		...
		'App\Presentation\Post\PostPresenter' => [2 => ['application.5']],
		'App\Presentation\Sign\SignPresenter' => [2 => ['application.6']],
	...
	public function createServiceApplication__1(): App\Presentation\Edit\EditPresenter
	{
	...
	public function createServiceApplication__5(): App\Presentation\Post\PostPresenter
	{
	...
	public function createServiceApplication__6(): App\Presentation\Sign\SignPresenter
	{
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\blog/temp/cache/nette.application/touch',
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\blog/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\blog/temp/cache', $this->getService('cache.journal'));
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=blog', /*sensitive{*/'root'/*}*/, null, []);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			public function __construct(
				private Container_f29d373a23 $container,
			) {
			}
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\blog/temp/cache/latte');
